...
/**
 * Code obtained from:
 * http://introcs.cs.princeton.edu/java/stdlib/StdRandom.java.html Licenced in
 * GNU GPL GNU General Public License, version 3 (GPLv3)
 */
...
public final class StdRandom {
        ...
        /**
         * Returns a boolean, which is true with probability p, and false
         * otherwise.
         * 
        ...
        /**
         * Returns a number from a discrete distribution: i with probability
         * a[i]. throws IllegalArgumentException if sum of array entries is not
         * (very nearly) equal to <tt>1.0</tt> throws IllegalArgumentException
        ...
        /**
         * Returns a real number from an exponential distribution with rate
         * lambda.
         * 
         * @throws IllegalArgumentException
        ...
        /**
         * Returns a real number from a gaussian distribution with given mean
         * and stddev
         */
        ...
        /**
         * Returns a real number with a Pareto distribution with parameter
         * alpha.
         * 
         * @throws IllegalArgumentException
        ...
        public static void shuffle(final double[] a, final int lo, final int hi) {
                if (lo < 0 || lo > hi || hi >= a.length)
                        throw new IndexOutOfBoundsException(
                                        "Illegal subarray range");
                for (int i = lo; i <= hi; i++) {
                        final int r = i + uniform(hi - i + 1); // between i and
                                                               // hi
                        final double temp = a[i];
                        a[i] = a[r];
                        a[r] = temp;
